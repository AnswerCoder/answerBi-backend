...
import top.peng.answerbi.model.dto.user.UserAddRequest;
import top.peng.answerbi.model.dto.user.UserLoginRequest;
import top.peng.answerbi.model.dto.user.UserQueryRequest;
import top.peng.answerbi.model.dto.user.UserRegisterRequest;
import top.peng.answerbi.model.dto.user.UserUpdateMyRequest;
import top.peng.answerbi.model.dto.user.UserUpdateRequest;
...
public class UserController {
     ...
     */
    @PostMapping("/login")
    public CommonResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
     ...
     */
    @PostMapping("/logout")
    public CommonResponse<Boolean> userLogout(HttpServletRequest request) {
        if (request == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
    ...
    public CommonResponse<LoginUserVO> getLoginUser(HttpServletRequest request) {
    ...
    public CommonResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
    ...
    @PostMapping("/delete")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public CommonResponse<Boolean> deleteUser(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
    ...
    @GetMapping("/get")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public CommonResponse<User> getUserById(long id, HttpServletRequest request) {
        if (id <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
     ...
     */
    @GetMapping("/get/vo")
    public CommonResponse<UserVO> getUserVOById(long id, HttpServletRequest request) {
        CommonResponse<User> response = getUserById(id, request);
